...
public class RestaurantServiceMockitoTestStub {
  ...
  public void  testFindNearbyWithin3km() throws IOException {
    ...
    GetRestaurantsRequest getRestaurantsRequestNoramalhour= new GetRestaurantsRequest(20.0, 30.2);
    GetRestaurantsRequest getRestaurantsRequestPeakhour= new GetRestaurantsRequest(21.0,31.1);

    allRestaurantsCloseByOffPeakHours= restaurantService.findAllRestaurantsCloseBy(getRestaurantsRequestNoramalhour, LocalTime.of(3,0));
    allRestaurantsCloseByPeakHours= restaurantService.findAllRestaurantsCloseBy(getRestaurantsRequestPeakhour, LocalTime.of(19,0));
